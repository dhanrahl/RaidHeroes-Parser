...
If ($RaidFolder = $RaidFolderCreation2 ) { 
...
Else { New-Item -Path "$env:USERPROFILE\Dropbox\Raid Parses" -Name "$RaidDay1 & $RaidDay2" -ItemType Directory }
